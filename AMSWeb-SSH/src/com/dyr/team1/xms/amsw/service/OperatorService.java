...
public class OperatorService {
	 ...
	 * @return
	 */
	public List<RoleMenu> getRoleMenuListByRoleId(Integer id) {
		return roleMenuDAO.selectRoleMenuListByRoleId(id);
	}
	 ...
	 * @return
	 */
	public List<Asset> getAssetsByCateName(int id) {
		return assetDAO.selectAssetsByCateId(id);
	}
